...
pred <- SingleR(test = adata, ref = ref, labels = translated)

# Convert prediction to DataFrame and assign to adata
pred_df <- as.data.frame(pred)
adata$SingleR <- pred_df$labels

# Save annotated data back to h5ad format
writeH5AD(adata,'/Users/srivalli/Documents/GitHub/hofmann_dmd/data/annotated_full_ont_data.h5ad')