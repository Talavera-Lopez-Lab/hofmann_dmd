...
pred <- SingleR(test = cardiac_data, ref = ref, labels = ref$label.main)
...
writeH5AD(cardiac_data,'/Users/srivalli/Documents/GitHub/hofmann_dmd/data/annotated_WT_data.h5ad')