...
pred <- SingleR(test = mdxscid_data, ref = ref, labels = ref$label.main)
...
writeH5AD(mdxscid_data,'/Users/srivalli/Documents/GitHub/hofmann_dmd/data/annotated_mdxscid_data.h5ad')